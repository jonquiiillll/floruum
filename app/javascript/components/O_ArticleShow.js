  ...
  render () {
    ...
    <div className="all_article_show">
      <div className="cont_art">
        <div className="container_show_article" style={{backgroundImage: `linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, rgba(0, 0, 0, 0.5) 100%), url(${this.props.article.preview.url})` }}>
