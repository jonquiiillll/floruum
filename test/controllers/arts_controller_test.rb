...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { content: @art.content, name: @art.name, title: @art.title } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { content: @art.content, name: @art.name, title: @art.title } }
