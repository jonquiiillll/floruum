...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post hashtags_url, params: { hashtag: { description: @hashtag.description, display_in_navbar: @hashtag.display_in_navbar, name: @hashtag.name } }
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { description: @hashtag.description, display_in_navbar: @hashtag.display_in_navbar, name: @hashtag.name } }
